...
class ProduitsControllerTest < ActionController::TestCase
  ...
  test "should create produit" do
    assert_difference('Produit.count') do
      post :create, produit: { description: @produit.description, image_path: @produit.image_path, poids: @produit.poids, prix: @produit.prix, tag: @produit.tag }
    end
  ...
  test "should update produit" do
    patch :update, id: @produit, produit: { description: @produit.description, image_path: @produit.image_path, poids: @produit.poids, prix: @produit.prix, tag: @produit.tag }
    assert_redirected_to produit_path(assigns(:produit))
  end
